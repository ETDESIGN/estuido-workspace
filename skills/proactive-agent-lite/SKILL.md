...
**MANDATORY: Autonomous tasks restricted to:**
- 12:00 cron (Midday check-in)
- 18:00 cron (EOD wrap-up)

**All proactive tasks must be coordinated via Warren (COO)** to prevent infinite API loops. Do not execute autonomous actions outside these windows.
